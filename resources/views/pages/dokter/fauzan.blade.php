                ...
                <table class="table-bordered mb-3 " style="width: 770px; height: 80px; text-align: center;">
                  ...
                  <div class="card rounded-5 mb-3" style="height: 139px; width: 770px; background-color: #ffffff;">
                    ...
                    <div class="row p-2" style="margin-left: 2px;">
                        <li>2008, Subsp.Ped(K), Universitas Indonesia</li>
                        <li>2008, dr., Universitas Indonesia</li>
                        <li>2010, S.Ked, Universitas Indonesia</li>
                      </div>
                    </div>
                    <div class="card rounded-5 " style="height: 139px; width: 770px; background-color: #ffffff;">
                        ...
                        <div class="row p-2" style="margin-left: 2px;">
                            <li>2012, Penulis Utama, Effects of intestinal strangulation release on liver</li>
                            <li>2021, Penulis, Analysis of knowledge regarding Biliary Atresia among healthcare</li>
                            <li>2021, Penulis Utama, Diagnosis dan Tatalaksana Ruptur Diafragma</li>
                          </div>
                        </div>
                        <a href="drfauzan">
